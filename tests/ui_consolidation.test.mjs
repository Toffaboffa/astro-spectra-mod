...
assert.ok(spectrapro.includes('stateStore.js?v=3.1.6-provenance-1'), 'published state store must use the source-provenance cache key');
...
assert.ok(stateStore.includes("const AI_ASSET_VERSION = '3.1.6-provenance-1';"), 'dynamic export/AI/example modules must use the source-provenance cache key');
