...
assert.ok(spectrapro.includes('dataQualityPanel.js?v=3.1.6-match-mae-final'), 'published Data Quality module must use the final separate match-MAE cache key');
...
assert.ok(stateStore.includes("const AI_ASSET_VERSION = '3.1.6-match-mae-final';"), 'dynamic export/AI modules must use the final separate match-MAE cache key');
