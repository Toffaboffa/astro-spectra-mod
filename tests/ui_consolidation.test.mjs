...
assert.ok(spectrapro.includes('proBootstrap.js?v=3.1.6-scale-1'), 'published hardware panel must use the nominal-vs-calibrated scale cache key');
...
assert.ok(stateStore.includes("const AI_ASSET_VERSION = '3.1.6-scale-1';"), 'dynamic export/AI modules must use the nominal-vs-calibrated scale cache key');
