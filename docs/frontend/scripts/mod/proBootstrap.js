  ...
  function ensurePanelContent() {
    ...
    if (core && !core.dataset.built) {
      ...
      card.innerHTML = [
        ...
        '    <label id="spFieldCombined" class="sp-field sp-field--checkbox-row sp-field--checkbox-inline" title="Show or hide the combined signal trace."><span>Combined</span><input id="spToggleCombinedProxy" type="checkbox"></label>',
        ...
        '    <div class="sp-mini-row"><span>Dark graph</span><input id="spToggleDarkProxy" type="checkbox" disabled></div>',
        '    <div class="sp-mini-row"><span>Reference graph</span><input id="spToggleRefProxy" type="checkbox" disabled></div>',
        '  </div>',
