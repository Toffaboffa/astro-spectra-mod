(function (global) {
  ...
  function compactCalibrationDiagnostics(value) {
    ...
    return {
      ...
      fitDegreesOfFreedom: rounded(value.fitDegreesOfFreedom, 0),
      fitResidualIndependent: typeof value.fitResidualIndependent === 'boolean' ? value.fitResidualIndependent : null,
      exactInterpolation: value.exactInterpolation === true,
      fitResidualStatus: cleanString(value.fitResidualStatus, 64) || null,
