(function (global) {
  ...
  const SV = {
    ...
    'Narrow emission lines': 'Smala emissionslinjer',
    'Additional line candidates': 'Ytterligare linjekandidater',
    'Clear coherent line matches are marked in the graph. Click a peak to inspect it.': 'Tydliga sammanhängande linjeträffar markeras i grafen. Klicka på en topp för att granska den.',
    'No clear multi-line atomic signature detected.': 'Ingen tydlig atomär flerlinjesignatur detekterades.',
