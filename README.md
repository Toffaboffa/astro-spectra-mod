...
- The language choice is not persisted across reloads in v2.2.6; English is always the clean baseline after a new load.
...
`README.md` describes the current high-level v2.2.6 architecture and visible functionality.
