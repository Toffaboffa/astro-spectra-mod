...
- The language choice is not persisted across reloads in v2.2.7; English is always the clean baseline after a new load.
...
`README.md` describes the current high-level v2.2.7 architecture and visible functionality.
